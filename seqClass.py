...
if re.search('^[ACGTU]+$', args.seq):
    if re.search('\W*(UT)\W*', args.seq):   # This regex searches specifically for pattern "UT" in case it's neither DNA nor RNA
        print ('The sequence is nothing')
    elif re.search('\W*(TU)\W*', args.seq):     # This regex searches specifically for the pattern "TU" in case it's neither DNA nor RNA
        print ('The sequence is nothing')
